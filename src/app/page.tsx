export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Hero Section */}
        <section id="home" className="bg-gradient-to-br from-green-50 to-emerald-100 py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              No Nonsense <span className="text-green-600">Product Building</span>
            </h1>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Senthil</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Abhinaya</h3>
              <p className="text-gray-600 mb-4">Co-Founder & Product Strategist</p>
              <a 
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-green-600 py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-gray-400">Building products at lightning speed</p>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <p className="text-gray-400">
              © 2024 Cincotree. Based in Dubai, serving the world.
            </p>
          </div>
        </div>
      </footer>
